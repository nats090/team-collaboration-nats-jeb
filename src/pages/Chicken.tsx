...
export default function Chicken() {
  ...
  const { data: productsData, isLoading } = useQuery({
    queryKey: ["chicken-products", category?.id, currentPage],
    enabled: !!category,
    queryFn: async () => {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: (product) => {
      ...
      logActivity({
        ...
        description: `Deleted chicken product: ${product?.name}`,
      });
    },
  });
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-warning">Chicken Products</h1>
            <p className="text-muted-foreground">Manage your chicken inventory</p>
          </div>
